...
const contactSchemaMongoose = new mongoose.Schema({
  ...
  avatarURL: String, // Додав нову властивість для збереження URL аватара
});
...
// Middleware для генерації аватара за допомогою gravatar перед збереженням користувача
...
// Middleware для хешування пароля перед збереженням користувача
...
async function updateContactAvatar(userId, avatarURL) {
  try {
